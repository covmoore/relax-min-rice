...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      table.insert(vimgrep_arguments, '--glob')
      table.insert(vimgrep_arguments, '!**/.local/*')
      table.insert(vimgrep_arguments, '--glob')
      ...
      telescope.setup {
        ...
        pickers = {
          find_files = {
            ...
            find_command = { 'rg', '--files', '--hidden', '--glob', '!**/.git/*', '--glob', '!**/.local/*', '--glob', '!**/.cache/*' },
          },
        },
        extensions = {
          ['ui-select'] = {
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        ts_ls = {},
        --
        zls = {}, -- Zig language server (intellisense, completion, diagnostics)
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        ...
        additional_vim_regex_highlighting = { 'ruby', 'zig', 'react', 'javascript' },
      },
